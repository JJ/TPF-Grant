...
ggplot(commits.t, aes(x=Month,y=Ratio,group=1))+geom_line()+theme_tufte()
ggplot(commits.t, aes(x=Month,y=Entropy,color=Commits,size=Authors,group=1))+geom_line()+theme_tufte()
