...
There is no clear trend here. The number of cifferent authors hovers between 10 and 30 every month, with a hitherto never reached again peak of more than 40 when Perl 6 was officialy released in Christmas 2015. Peaks usually correspond to Rakudo Star or stable releases, but the local maximum of April 2018, the first month of the grant, was the highest since September 2017. It should be noted that author peaks do not match contribution peak. New authors might be contributing just a few or a single commit. 
